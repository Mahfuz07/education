            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="${pageContext.request.contextPath}/admin/updateLessonNotes" method="post" enctype="multipart/form-data">
...
<%--                                    </button>--%>
<%--                                </span>--%>
<%--                                <input accept=".pdf" type="file" name="file" id="files-input-upload" style="display: none;">--%>
