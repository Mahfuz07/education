        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header">
                    <i class="fa fa-file-pdf-o"></i> Event Notes
                </h2>
            </div>
        </div>
            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="${pageContext.request.contextPath}/admin/updateEventNotes" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group">
                                ...
                                <label class="input-group-btn">
                                        <span class="btn btn-primary">
                                            Brows &hellip; <input accept=".pdf" type="file" name="file" style="display: none;">
                                        </span>
                                </label>
...
<%--                                    </button>--%>
<%--                                </span>--%>
<%--                                <input name="file" type="file" id="files-input-upload" style="display:none">--%>
