                    ...
                    <div class="modal-body" style="overflow: auto;">
                        <div class="col-md-8">
                            <div class="courseVideoFrame" style="width:100%; height: 100%; background: #333; padding: 20px 20px 20px 20px; box-sizing: border-box;">
                                <iframe width="854" height="480" type="text" src="{{selectedtopics.videoUrl| trustAsResourceUrl}}" frameborder="0" allowfullscreen></iframe>
                        ...
                        <sec:authorize access="isAuthenticated()">
                            ...
                            <input type="hidden" type="text" ng-model="userName = '${username}'"/>
                            <input type="hidden" type="number" ng-model="topicsId = selectedtopics.topicsId"/>
