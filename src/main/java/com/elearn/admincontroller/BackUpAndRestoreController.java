...
public class BackUpAndRestoreController {
    ...
    public String doBackUp(HttpServletRequest request, Model model) {
        ...
        String dumpExePath = mainURLPath + "/main/webapp/resources/exe/mysqldump.exe";
        String host = "localhost";
        String port = "3306";
        String user = "root";
        String password = "Am27692921";
        String database = "elearn_class";
        String backupPath = mainURLPath + "/main/webapp/resources/backup";
